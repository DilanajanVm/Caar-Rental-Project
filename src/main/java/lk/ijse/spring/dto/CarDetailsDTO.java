...
public class CarDetailsDTO {
    ...
    public CarDetailsDTO(String carNumber, String carModel, String carType, String carImg01, String carImg02, String carImg03, String carImg04, String carTransmissionType, String carFuelType, String carColor, boolean carAvailerlibilty, int passenger, double carDailyRate, double carMonthlyRate, double carFreeKmForADay, double carFreeKmForAMonth, double carPriceForExtraKM) {
    ...
    public String toString() {
        return "CarDetailsDTO{" +
                ...
                ", carColor='" + carColor + '\'' +
                ", carAvailerlibilty=" + carAvailerlibilty +
                ", passenger=" + passenger +
                ", carDailyRate=" + carDailyRate +
                ", carMonthlyRate=" + carMonthlyRate +
                ", carFreeKmForADay=" + carFreeKmForADay +
                ", carFreeKmForAMonth=" + carFreeKmForAMonth +
