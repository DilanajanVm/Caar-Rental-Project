...
public class DriverDetailDTO {
    ...
    public DriverDetailDTO(String driver_NIC, String driver_name, String driver_Address, String email, int driver_contact, boolean driver_Availability, String driver_ShecduleDec, String driver_password) {
